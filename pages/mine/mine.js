...
Page({
      ...
      success: function (res) {
        ...
        if (res.data.status == 200) {
          ...
          if (userInfo.faceImage != null && userInfo.faceImage != '' && userInfo.faceImage != undefined) {
            faceUrl = fileUrl + userInfo.faceImage;
          }
  ...
  getMyVideoList: function (page) {
    ...
    var serverUrl = app.serverUrl;
    wx.request({
      url: serverUrl + '/video/showAll/?page=' + page + '&pageSize=6' +"&type=" + me.data.type + "&latitude=" + me.data.latitude + "&longitude=" + me.data.longitude,
      method: "POST",
      data: {
